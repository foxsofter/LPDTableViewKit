...
- (void)viewDidLoad {
  ...
  UIBarButtonItem *replaceCellBarButtonItem =
  [[UIBarButtonItem alloc] initWithTitle:@"rpc" style:UIBarButtonItemStylePlain target:self action:@selector(rplaceCell)];
